  ...
  + assert (n0 <= sup).
    ...
    { apply NNPP. intro Hempty.
      ...
      { unfold P' in HP'.
        ...
        specialize (HLUB _ H0). unfold leq in HLUB. omega.
      }
    }
    destruct Hsup as [HUB HLUB].
    assert (is_sup P' sup) as Hsup'.
    { unfold P'. split.
      - intros m Hm. unfold leq.
        specialize (HUB _ Hm). unfold leq in HUB. omega.
      - intros m Hm. unfold leq.
        assert (S sup <= S m) as HSm.
        { apply HLUB. intros k Hk. unfold leq.
